...
<body>
    ...
    <div class=" text-center mx-auto w-auto text-2xl   my-24 mb-17">
        <div class="mb-4">
            <img class=" w-28 md:w-32 mx-auto mt-4 " src="{{ asset ('images/check.gif') }}">
        </div>
        <div>
            <p class="mx-16 text-lg sm:text-3xl font-semibold text-neutral-700 mb-24 mt-9 px-10 rounded-lg py-1 ">
