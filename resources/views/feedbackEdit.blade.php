...
<body>
    ...
    <form action="{{ route('feedback.store') }}" method="post">
        ...
        <div
            ...
            <div class=" text-center mx-auto w-auto text-2xl  mb-9 mt-16 ">
                <p class="mx-16  ">
            ...
            <div class=" sm:mx-auto mx-auto mb-1 ">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 md:flex mx-3  sm:mx-auto sm:mt-9">
                    ...
                    <li class="list-none">
                        <input type="radio" name="rating" id="regular"  value="1" class="hidden btn regular peer">
            ...
            <div>
                <button type="submit" id="submitButton" value="Submit" onclick="submitForm(this);"
                    class=" py-1 px-4 mb-9 font-bold text-md sm:text-lg transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110  duration-300  bg-violet-500 hover:bg-violet-600 active:bg-violet-700 focus:outline-none focus:ring focus:ring-violet-300 text-white rounded-2xl h-10 w-28 text-center">
                    Enviar
                </button>
            </div>
    </form>
